...
void Vampire::receiveAttack(Human *attacker) {this->HP-=attacker->getAtk();}
void Vampire::receiveAttack(Vampire *attacker) {this->HP-=attacker->getAtk();}
void Vampire::receiveAttack(Werewolf *attacker) {this->HP-=attacker->getAtk();}